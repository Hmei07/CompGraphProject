...
let createBall = () => {
  ...
  matBall = new THREE.MeshPhongMaterial({ color: "red", transparent: true });
...
let createBox = () => {
  ...
  let mat = new THREE.MeshPhongMaterial({ color: "blue", transparent: true });
...
let createDodecahedron = () => {
  ...
  let mat = new THREE.MeshPhongMaterial({ color: "green", transparent: true });
